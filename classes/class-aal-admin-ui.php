...
class AAL_Admin_Ui {
	...
	public function create_admin_menu() {
		...
		$this->_screens['main'] = add_menu_page( _x( 'Activity Log', 'Page and Menu Title', 'aryo-activity-log' ), _x( 'Activity Log', 'Page and Menu Title', 'aryo-activity-log' ), $menu_capability, 'activity_log_page_wp', array( &$this, 'activity_log_page_func' ), '', '2.1' );
...
remove_menu_page( 'activity_log_page_wp' );
}
